...
- **[creeperkatze/modfolio](https://github.com/creeperkatze/modfolio)** ([Website](https://modfolio.creeperkatze.de)) - A flexible, reusable and fast embed generator for all things Modrinth. Get styled details about a user, project, organization or collection.
